package org.athento.nuxeo.operations.template;
...
/**
 * Add an image in a localization into template.
 */
@Operation(id = AddImageInTemplateOperation.ID, category = "Athento", label = "Get iframe for document preview", description = "Return an HTML code into iframe component to show a document preview.")
public class AddImageInTemplateOperation {

	/** Log. */
	private static final Log LOG = LogFactory.getLog(AddImageInTemplateOperation.class);
