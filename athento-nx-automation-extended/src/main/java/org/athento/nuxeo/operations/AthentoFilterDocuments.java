...
public class AthentoFilterDocuments {
        ...
        protected class Condition implements Filter {
            ...
            Condition() {
                String v = AthentoFilterDocuments.this.types;
                if (v != null) {
                    v = v.trim();
                    if (v.length() > 0) {
                ...
                v = AthentoFilterDocuments.this.facet;
                if (v != null) {
                    v = v.trim();
                    if (v.length() > 0) {
                        facet = v;
                ...
                v = AthentoFilterDocuments.this.attr;
                if (v != null) {
